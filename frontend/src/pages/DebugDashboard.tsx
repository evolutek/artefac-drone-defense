...
export function DebugDashboard() {
  ...
  console.log('[DebugDashboard] Initializing drones:', initializingDrones.size, 'Latest event:', latestEvent?.type);
      ...
      <header className="bg-blue-600 text-white shadow-lg">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold">Artefac Drone Defense - Debug Dashboard</h1>
